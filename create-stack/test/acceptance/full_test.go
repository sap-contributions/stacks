...
func testFull(cliPath string) func(*testing.T, spec.G, spec.S) {
	return func(t *testing.T, when spec.G, it spec.S) {
		...
		it("builds full jammy-stack", func() {
			...
			Expect(buildImageConfig.StackLabels.Description).To(Equal("ubuntu:jammy + many common C libraries and utilities"))
			...
			Expect(runImageConfig.StackLabels.Description).To(Equal("ubuntu:jammy + many common C libraries and utilities"))
